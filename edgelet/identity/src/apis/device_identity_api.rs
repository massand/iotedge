...
pub struct DeviceIdentityApiClient<C: hyper::client::connect::Connect> {
    configuration: Arc<configuration::Configuration<C>>,
}

impl<C: hyper::client::connect::Connect> DeviceIdentityApiClient<C> {
    pub fn new(configuration: Arc<configuration::Configuration<C>>) -> DeviceIdentityApiClient<C> {
        DeviceIdentityApiClient { configuration }
    }
}

pub trait DeviceIdentityApi {
    fn get_api_versions(
        &self,
...
impl<C> DeviceIdentityApi for DeviceIdentityApiClient<C>
where
    ...
    <C as hyper::client::connect::Connect>::Future: 'static,
{
    ...
    ) -> Box<dyn Future<Item = crate::models::IdentityResult, Error = Error<serde_json::Value>>>
    {
        ...
        let uri_str = format!("/identities/apiversions");
    ...
    ) -> Box<dyn Future<Item = crate::models::IdentityResult, Error = Error<serde_json::Value>>>
    {
        ...
        let query = ::url::form_urlencoded::Serializer::new(String::new())
            ...
            .finish();
        let uri_str = format!("/identities/aziot/device?{}", query);
    ...
    fn reprovision_device(
        ...
        let query = ::url::form_urlencoded::Serializer::new(String::new())
            .append_pair("api-version", &api_version.to_string())
            .finish();
        let uri_str = format!("/identities/aziot/device/reprovision?{}", query);
