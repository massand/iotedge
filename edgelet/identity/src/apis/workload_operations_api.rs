...
pub struct WorkloadOperationsApiClient<C: hyper::client::connect::Connect> {
    configuration: Arc<configuration::Configuration<C>>,
}

impl<C: hyper::client::connect::Connect> WorkloadOperationsApiClient<C> {
    pub fn new(
        configuration: Arc<configuration::Configuration<C>>,
    ) -> WorkloadOperationsApiClient<C> {
        WorkloadOperationsApiClient {
            configuration: configuration,
        }
    }
}

pub trait WorkloadOperationsApi {
...
impl<C> WorkloadOperationsApi for WorkloadOperationsApiClient<C>
where
    ...
    <C as hyper::client::connect::Connect>::Future: 'static,
{
    ...
    ) -> Box<dyn Future<Item = crate::models::IdentityResult, Error = Error<serde_json::Value>>>
    {
        ...
        let query = ::url::form_urlencoded::Serializer::new(String::new())
            ...
            .finish();
        let uri_str = format!("/identities/aziot/identity?{}", query);
    ...
    fn sign(
        ...
        let query = ::url::form_urlencoded::Serializer::new(String::new())
            .append_pair("api-version", &api_version.to_string())
            .finish();
        let uri_str = format!("/identities/aziot/identity/sign?{}", query);
