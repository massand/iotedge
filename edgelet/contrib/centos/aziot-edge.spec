...
%define iotedge_rundir /run/aziot/edged
...
# sockets
%attr(660, %{iotedge_user}, %{iotedge_group}) %{iotedge_rundir}/aziot-edged.mgmt.sock
%attr(666, %{iotedge_user}, %{iotedge_group}) %{iotedge_rundir}/aziot-edged.workload.sock
