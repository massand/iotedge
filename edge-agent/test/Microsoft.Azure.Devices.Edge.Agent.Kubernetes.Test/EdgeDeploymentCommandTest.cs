...
namespace Microsoft.Azure.Devices.Edge.Agent.Kubernetes.Test
{
    ...
    public class EdgeDeploymentCommandTest
    {
        ...
        public void ConstructorThrowsOnInvalidParams()
        {
            ...
            Assert.Throws<ArgumentException>(() => new EdgeDeploymentCommand(null, ResourceName, DefaultClient, modules, Option.None<EdgeDeploymentDefinition>(), Runtime, ConfigProvider, EdgeletModuleOwner));
            Assert.Throws<ArgumentNullException>(() => new EdgeDeploymentCommand(Namespace, null, DefaultClient, modules, Option.None<EdgeDeploymentDefinition>(), Runtime, ConfigProvider, EdgeletModuleOwner));
            Assert.Throws<ArgumentNullException>(() => new EdgeDeploymentCommand(Namespace, ResourceName, null, modules, Option.None<EdgeDeploymentDefinition>(), Runtime, ConfigProvider, EdgeletModuleOwner));
            Assert.Throws<ArgumentNullException>(() => new EdgeDeploymentCommand(Namespace, ResourceName, DefaultClient, null, Option.None<EdgeDeploymentDefinition>(), Runtime, ConfigProvider, EdgeletModuleOwner));
            Assert.Throws<ArgumentNullException>(() => new EdgeDeploymentCommand(Namespace, ResourceName, DefaultClient, modules, Option.None<EdgeDeploymentDefinition>(), Runtime, ConfigProvider, EdgeletModuleOwner));
            Assert.Throws<ArgumentNullException>(() => new EdgeDeploymentCommand(Namespace, ResourceName, DefaultClient, modules, Option.None<EdgeDeploymentDefinition>(), null, ConfigProvider, EdgeletModuleOwner));
            Assert.Throws<ArgumentNullException>(() => new EdgeDeploymentCommand(Namespace, ResourceName, DefaultClient, modules, Option.None<EdgeDeploymentDefinition>(), Runtime, null, EdgeletModuleOwner));
            Assert.Throws<ArgumentNullException>(() => new EdgeDeploymentCommand(Namespace, ResourceName, DefaultClient, modules, Option.None<EdgeDeploymentDefinition>(), Runtime, ConfigProvider, null));
        }
